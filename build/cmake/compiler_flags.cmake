...
function(add_c_flag_if_supported c_flag)
  ...
  if(${C_FLAG_SUPPORTED})
    ...
    #foreach(config ${AOM_C_CONFIGS})
      unset(C_FLAG_FOUND)
      separate_arguments(flags_sep UNIX_COMMAND ${c_flag})
      add_compile_options("$<$<COMPILE_LANGUAGE:C>:${flags_sep}>")
    #endforeach()
  else()
...
function(add_cxx_flag_if_supported cxx_flag)
  ...
  if(${CXX_FLAG_SUPPORTED})
    ...
    #foreach(config ${AOM_CXX_CONFIGS})
      ...
      separate_arguments(flags_sep UNIX_COMMAND ${cxx_flag})
      add_compile_options("$<$<COMPILE_LANGUAGE:CXX>:${flags_sep}>")
    #endforeach()
  else()
...
function(require_cxx_flag cxx_flag update_cxx_flags)
  ...
  if(update_cxx_flags)
    foreach(config ${AOM_CXX_CONFIGS})
      set(${config} "${${config}} ${cxx_flag}")  # SDL edit: don't cache CMAKE_<lang>_FLAGS_<config>: plain setting will apply it to all subdirectories
    endforeach()
  endif()
endfunction()
